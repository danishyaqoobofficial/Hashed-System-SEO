      ...
      <>
        <main className=" w-full bg-[#fff] relative ">
            <section className="h-[100vh] max-w-[1440px] w-full mx-auto px-[15px] md:px-[20px] ">
                <Navbar/>
                <div className=" max-w-[730px] mx-auto mt-[90px] sm:mt-[110px] md:mt-[150px] !z-30 ">
                    <h2 className="text-[##0A0E19] text-center text-[28px] sm:text-[42px] md:text-[52px] font-[400] leading-[38px] sm:leading-[52px] md:leading-[60px] ">Achieve Clear Results with Online Marketing</h2>
                    <p className="mt-[15px] text-center text-[14px] sm:text-[16px] md:text-[17px] font-[300] text-[#0A0E19] ">Optimize your website to rank higher on search engines and attract more organic traffic.</p>
                    <div className="md:w-[94%] mx-auto border-[1.4px] border-[#BEC1CC] relative !z-30 p-[4px] sm:p-[5px] rounded-[9px] flex mt-[42px] h-[52px] sm:h-[59px] shadow-lg ">
                ...
                <div className="flex items-center justify-center absolute bottom-0 left-0 right-0 !z-10 ">
