                ...
                <div className=" max-w-[460px] mx-auto mt-[100px] sm:mt-[140px] ">
                    ...
                    <div className="mt-[22px] ">
                        ...
                        <div className="mt-[18px] flex items-center justify-center ">
                            <Link to={'/dashboard'} className=" cursor-pointer px-[16px] py-[6px] rounded-[30px] bg-[#E0F2FF] flex items-center justify-center text-[#0D99FF] text-[13px] md:text-[14px] font-[300] ">
                                @ Avinash Kaushik
                            </Link>
                        </div>
                    </div>
