      ...
      <>
        <main className=" w-full bg-[#fff] relative ">
            <section className="h-[100vh] max-w-[1220px] w-full mx-auto px-[15px] md:px-[20px] flex items-center justify-center ">
                <div className="max-w-[400px] w-full border-[#C0D6E7] border rounded-[12px] p-[22px] ">
                    ...
                    <div className='w-[62%] mx-auto '>
                        ...
                        <div className='flex items-center justify-center gap-[9px] mt-[22px] '>
                            <input className=' outline-none text-[30px] text-[#000000] border border-[#DBDADF] rounded-[6px] w-[50px] h-[50px] p-[16px] flex items-center justify-center ' type="text" />
                            <input className=' outline-none text-[30px] text-[#000000] border border-[#DBDADF] rounded-[6px] w-[50px] h-[50px] p-[16px] flex items-center justify-center ' type="text" />
                            <input className=' outline-none text-[30px] text-[#000000] border border-[#DBDADF] rounded-[6px] w-[50px] h-[50px] p-[16px] flex items-center justify-center ' type="text" />
                            <input className=' outline-none text-[30px] text-[#000000] border border-[#DBDADF] rounded-[6px] w-[50px] h-[50px] p-[16px] flex items-center justify-center ' type="text" />
                        </div>
