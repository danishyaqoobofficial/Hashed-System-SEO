...
const Topbar = ({setExpandSidebar, expandSidebar}) => {
    ...
    return (
        <>
            <nav className='flex items-center justify-between bg-[#fff] fixed top-0 px-[16px] sm:px-[22px] py-[11px] border-b border-[#E5E6EE] w-full ' >
                <span className='flex items-center justify-center cursor-pointer ml-[60px] transition-all ' onClick={()=>setExpandSidebar(!expandSidebar)} >
                ...
                <div className='flex items-center gap-[16px] sm:gap-[22px] '>
                    ...
                    <div className=' relative '>
                        <div className={`flex items-center gap-[10px] border border-transparent cursor-pointer hover:border-[#b5bfd9] transition-all rounded-[30px] p-[5px] `} onClick={()=> setShowProfilePopup(!showProfilePopup)}>
                            ...
                            <span>
                                <i class={`fa-solid fa-angle-up text-[14px] text-[#9e9ca8] transition-all ${showProfilePopup ? 'rotate-270' : "rotate-180"} `}></i>
                            </span>
                        </div>
                    </div>
                </div>
